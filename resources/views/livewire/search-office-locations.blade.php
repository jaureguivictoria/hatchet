<div class="container mx-auto">
    ...
    @if ($officeLocations->isEmpty())
        <div class="p-4 text-sm text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-300 mt-5" role="alert">
            <span class="font-medium">No results</span> Change a few things filters and try submitting again.
        </div>
    ...
    <div wire:loading>
        <div role="status" class="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
            ...
            <span class="sr-only">Searching office locations ...</span>
        </div>
    </div>
